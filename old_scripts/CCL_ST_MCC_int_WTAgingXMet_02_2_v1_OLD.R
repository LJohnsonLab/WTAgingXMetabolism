########################################################################
# Name: CCL_ST_MCC_int_WTAgingXMet_02_2.R **ONLY TO BE RUN ON SUPERCOMPUTER (MCC)**
...
qs_save(anchors, "/mnt/gpfs3_amd/pscratch/lajo247_uksr/WTAgingXMet/output/20260511_int_anchors_02_2.qs2")
...
qs_save(integrated.obj, "/mnt/gpfs3_amd/pscratch/lajo247_uksr/WTAgingXMet/output/20260508_nodimreduc_integratedobj_02_2.qs2") 
...
integrated.obj <- FindClusters(integrated.obj, resolution = 0.5, graph.name = "SCT_snn")

# 06. Save SCTransformed integrated obj ----
qs_save(integrated.obj, "/mnt/gpfs3_amd/pscratch/lajo247_uksr/WTAgingXMet/output/20260508_final_integratedobj_02_2.qs2") 
